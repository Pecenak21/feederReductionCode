...
% dd = d1;
% p = p1;
% p='D:\Sync Software\Other Code\SystemConversion\HydroOttawa/HydroOttawa/HydroOttawa.dss';
p='C:\OpenDSS\HydroOttawa\HydroOttawa/HydroOttawa.dss';
...
t.Command = 'Solve';
t.Command = ['Export faultstudy HydroOttawa_fault.csv'];
y = faultread(t.Result);
t.Command = 'show faults';
t.command = ['cd "' pwd '"'];
t.Command = ['set editor="' olded '"']; % unsilence output
% % z = faultread([subdir '/HydroOttawa_fault_FaultStudy.Txt']);
% 
