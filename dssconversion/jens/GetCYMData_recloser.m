function[struc] = GetCYMData_recloser(FilePath)
...
%
% FORMAT_RECLOSERSETTING=1SectionID,2Location,3EqID,4DeviceNumber,5CoordX,
...
% 34RestorationMode,35ConnectionStatus,36ByPassOnRestoration,
% 37Reversible,38TCCSettingsSelection 
...
FilePath=[FileName '_RECLOSERSETTING.txt'];

if ~exist(FilePath)
    disp('"recloser" structure not populated');
    disp('File not found.');
    FilePath
    struc=[];
    return
