function[struc] = GetCYMData_breakersetting_SCE(FilePath)
...
%
% Format:
% FORMAT_BREAKERSETTING=1SectionID,2Location,3EqID,4DeviceNumber,5EqPhase,6CoordX,
% 7CoordY,8ClosedPhase,9Locked,10RC,11NStatus,12DemandType,13Value1A,14Value2A,
% 15Value1B,16Value2B,17Value1C,18Value2C,19Value1ABC,20Value2ABC,21TCCID,22Desc,
% 23PhPickup,24GrdPickup,25Alternate,26PhAltPickup,27GrdAltPickup,28FromNodeID,
% 29EnableReclosing,30FaultIndicator,31EnableFuseSaving,32MinRatedCurrentForFuseSaving,
% 33Automated,34SensorMode,35Strategic,36RestorationMode,37ConnectionStatus,38ByPassOnRestoration
