function[struc] = GetCYMData_sourceequivalent(FilePath)
...
struc.R0=y{8};
struc.X0=y{9};
struc.OperatingVoltage1=y{11};
struc.OperatingVoltage2=y{12};
struc.OperatingVoltage3=y{13};
struc.ImpedanceUnit=y{14};
